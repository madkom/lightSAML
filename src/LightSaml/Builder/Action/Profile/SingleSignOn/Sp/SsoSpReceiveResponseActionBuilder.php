...
class SsoSpReceiveResponseActionBuilder extends AbstractProfileActionBuilder
{
     ...
     */
    private $exchangeArtifactActionBuilder;
    /**
     * @var ActionBuilderInterface
     */
    private $validateAssertionValidateAssertionActionBuilder;

    /**
     * @param BuildContainerInterface $buildContainer
     * @param ActionBuilderInterface  $exchangeArtifactActionBuilder
     * @param ActionBuilderInterface  $validateAssertionValidateAssertionActionBuilder
     */
    public function __construct(BuildContainerInterface $buildContainer, ActionBuilderInterface $exchangeArtifactActionBuilder, ActionBuilderInterface $validateAssertionValidateAssertionActionBuilder)
    {
        parent::__construct($buildContainer);

        $this->buildContainer = $buildContainer;
        $this->exchangeArtifactActionBuilder = $exchangeArtifactActionBuilder;
        $this->validateAssertionValidateAssertionActionBuilder = $validateAssertionValidateAssertionActionBuilder;
    }
    ...
    protected function doInitialize()
    {
        $this->add(new ReceiveMessageAction(
            ...
            $this->exchangeArtifactActionBuilder->build()
        ));
        ...
        $this->add(new AssertionAction(
            $this->buildContainer->getSystemContainer()->getLogger(),
            $this->validateAssertionValidateAssertionActionBuilder->build()
        ));
