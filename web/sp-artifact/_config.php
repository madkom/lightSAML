...
class SpConfig
{
    ...
    private function buildOwnEntityDescriptorProvider(\LightSaml\Credential\X509Certificate $certificate)
    {
        return new \LightSaml\Builder\EntityDescriptor\ArtifactSupportedEntityDescriptorBuilder(
            self::OWN_ENTITY_ID,
            [
                ['location' => 'https://localhost/lightsaml/lightSAML/web/sp-artifact/acs.php', 'binding' => \LightSaml\SamlConstants::BINDING_SAML2_HTTP_POST],
                ['location' => 'https://localhost/lightsaml/lightSAML/web/sp-artifact/artifact.php', 'binding' => \LightSaml\SamlConstants::BINDING_SAML2_HTTP_ARTIFACT],
            ],
            null,
            null,
            null,
